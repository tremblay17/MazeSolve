...
def generate(num_mazes, colorArr, blockHeight, blockWidth, margin):
    for iter_maze in range(num_mazes):
        ...
        with open(f"/home/dyltrib/Documents/Programs/Python-Programs/py-astar/mazes/maze_({rows}x{cols})({timeInfo.hour}{timeInfo.minute}).csv", "w",
                  newline="") as c:
            writer = csv.writer(c)
...
if __name__ == "__main__":
    ...
    blockWidth = blockHeight
    margin = 0
    generate(num_mazes, colors, blockHeight, blockWidth, margin)

...
import pygame
import time
from ref import mover, nodePicker, Node
...
if __name__ == "__main__":
    ...
    address = f"E:\Automotive\Design\solver\mazes\{maze_file}.csv"
    ...
    with open(f"E:\Automotive\Design\solver\mazes\{maze_file}_solved", "w", newline="") as c:
        writer = csv.writer(c)
